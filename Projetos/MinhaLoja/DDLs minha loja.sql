...
ALTER TABLE USUARIOS_BLOQUEIOS ADD FOREIGN KEY (BLOQUEADO_POR) REFERENCES USUARIOS(ID);
...
ALTER TABLE VENDAS ADD FOREIGN KEY (FK_SITUACAO) REFERENCES SITUACOES_FINANCEIRAS (ID);
...
ALTER TABLE CREDITOS_RECEBER ADD FOREIGN KEY (FK_FORMA_PAGAMENTO) REFERENCES FORMAS_PAGAMENTO (ID);
...
--### PROCEDURE para bloqueio automático após 5 falhas em 15 minutos */
...
ADD CONSTRAINT CHK_PC_MARGEM_LUCRO CHECK (MARGEM_LUCRO BETWEEN 0 AND 100),
