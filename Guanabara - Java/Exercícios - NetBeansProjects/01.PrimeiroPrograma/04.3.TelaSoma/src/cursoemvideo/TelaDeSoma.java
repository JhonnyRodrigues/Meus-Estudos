...
public class TelaDeSoma extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Calculando a soma dos Numeros");
    ...
    private void btnSomaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSomaActionPerformed
       ...
       // int N1 = txtN1.getText();     SAO INCOMPATIVEIS STRING COM NUMERO, então:
        int N1 = Integer.parseInt(txtN1.getText()); //pega o valor(em string) do texBox, converte para inteiro e guarda em N1
        int N2 = Integer.parseInt(txtN2.getText()); //idem
        int s = N1 + N2;
        lblSoma.setText(Integer.toString(s));       //converte o inteiro para o tipo string e depois muda(set) o label
