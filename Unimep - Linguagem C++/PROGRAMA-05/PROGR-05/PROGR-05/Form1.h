...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label5->Location = System::Drawing::Point(188, 206);
			this->label5->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label5->Name = L"label5";
			this->label5->Size = System::Drawing::Size(142, 29);
			this->label5->TabIndex = 21;
			this->label5->Text = L"SITUAÇÃO";
			// 
			// label4
			// 
			...
			this->label4->Size = System::Drawing::Size(352, 26);
			...
			this->label3->Location = System::Drawing::Point(23, 124);
			this->label3->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(350, 26);
			...
			this->label2->Location = System::Drawing::Point(23, 70);
			this->label2->Margin = System::Windows::Forms::Padding(2, 0, 2, 0);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(488, 29);
			this->label2->TabIndex = 18;
			this->label2->Text = L"PROGRAMA PARA TESTAR IF SIMPLES";
			// 
			// label1
			// 
			...
			this->label1->Size = System::Drawing::Size(403, 31);
			...
			this->textBox3->Location = System::Drawing::Point(28, 246);
			this->textBox3->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->textBox3->Name = L"textBox3";
			this->textBox3->ReadOnly = true;
			this->textBox3->Size = System::Drawing::Size(563, 32);
			...
			this->textBox2->Location = System::Drawing::Point(391, 160);
			this->textBox2->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->textBox2->Name = L"textBox2";
			this->textBox2->Size = System::Drawing::Size(76, 37);
			...
			this->textBox1->Location = System::Drawing::Point(391, 119);
			this->textBox1->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->textBox1->Name = L"textBox1";
			this->textBox1->Size = System::Drawing::Size(76, 37);
			...
			this->button3->Location = System::Drawing::Point(411, 295);
			this->button3->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->button3->Name = L"button3";
			this->button3->Size = System::Drawing::Size(180, 41);
			...
			this->button2->Location = System::Drawing::Point(209, 295);
			this->button2->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(177, 41);
			...
			this->button1->Location = System::Drawing::Point(23, 295);
			this->button1->Margin = System::Windows::Forms::Padding(2, 2, 2, 2);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(169, 41);
			...
			this->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(255)), static_cast<System::Int32>(static_cast<System::Byte>(192)), 
				static_cast<System::Int32>(static_cast<System::Byte>(192)));
			this->ClientSize = System::Drawing::Size(654, 345);
...
if (NRO1 == NRO2)
{
	this->textBox3->Text=("OS NÚMEROS DIGITADOS SÃO IGUAIS");
}
else
{
	this->textBox3->Text=("OS NÚMEROS DIGITADOS SÃO DIFERENTES");
}
}
